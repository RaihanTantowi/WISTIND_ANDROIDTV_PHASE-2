...
public class VideoContentCardPresenter extends Presenter {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        sDefaultBackgroundColor = ContextCompat.getColor(context, R.color.app_guidedstep_subactions_background);
        sSelectedBackgroundColor = ContextCompat.getColor(context, R.color.settings_background);
