...
package androidx.leanback.wistind.app.room.controller.detail;
...
import androidx.leanback.wistind.app.room.adapter.ListAdapter;
import androidx.leanback.wistind.app.room.config.AppConfiguration;
import androidx.leanback.wistind.app.room.controller.app.SampleApplication;
import androidx.leanback.wistind.app.room.db.entity.VideoEntity;
import androidx.leanback.wistind.app.room.di.action.qualifier.LoadingActionQualifier;
import androidx.leanback.wistind.app.room.di.action.qualifier.PlayActionQualifier;
import androidx.leanback.wistind.app.room.di.action.qualifier.PreviewActionQualifier;
import androidx.leanback.wistind.app.room.di.action.qualifier.RentActionQualifier;
import androidx.leanback.wistind.app.room.di.adapter.qualifier.DetailFragmentArrayObjectAdapterForActionsQualifier;
import androidx.leanback.wistind.app.room.di.adapter.qualifier.DetailFragmentArrayObjectAdapterForRowsQualifier;
import androidx.leanback.wistind.app.room.di.adapter.qualifier.ListAdapterForRelatedRowQualifier;
import androidx.leanback.wistind.app.room.di.subcomponentinjection.DaggerApplicationComponent;
import androidx.leanback.wistind.app.room.network.NetworkLiveData;
