...
import androidx.leanback.wistind.cards.presenters.IconCardInChannelPublishPresenter;
import androidx.leanback.wistind.models.Card;
import androidx.leanback.wistind.models.CardRow;
import androidx.leanback.wistind.utils.CardListRow;
...
public class DynamicRowsFragment extends BrowseFragment {
     ...
     *
     */
    public void setOnIconClickedListener(View.OnClickListener listener) {
        View view = this.getView().findViewById(R.id.clock);
        if (view != null) {
    ...
    private void setupUi() {
        ...
        setOnIconClickedListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity().getBaseContext(), SettingsExampleActivity.class));
            }
        });
    }
